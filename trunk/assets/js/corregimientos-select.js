jQuery(function ($) {
  ...
  // pa_corregimientos_select_params is required to continue, ensure the object exists
  // wc_country_select_params is used for select2 texts. This one is added by WC
  if (typeof wc_country_select_params === 'undefined' || typeof pa_corregimientos_select_params === 'undefined') {
    return false;
  }
  ...
  /* City select boxes */
  var cities_json = pa_corregimientos_select_params.cities.replace(/&quot;/g, '"');
  ...
  function cityToSelect($citybox, current_cities) {
    ...
    $citybox.html('<option value="">' + pa_corregimientos_select_params.i18n_select_city_text + '</option>' + options);
